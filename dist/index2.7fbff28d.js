    ...
    geographyConfig: {
        popupTemplate: function(geo, data) {
            var country = AllCountriesDataHolder[0].response.find(function(countryData) {
                if (geo.properties.name == "United States of America") return geo.properties.name;
                else if (geo.properties.name == "Saudi Arabia") return geo.properties.name;
                else if (geo.properties.name == "United Arab Emirates") return geo.properties.name;
                else if (geo.properties.name == "united Kingdom") return geo.properties.name;
                else if (countryData.country == geo.properties.name) return geo.properties.name;
            });
            return [
...
//# sourceMappingURL=index2.7fbff28d.js.map
