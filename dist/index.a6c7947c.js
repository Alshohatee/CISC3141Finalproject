...
if (!document.cookie) _userInfo.getUserInfo();
else {
...
init();
_api.getCookie().then((cookie)=>{
    _api.weatherAPI(cookie).then((res)=>{
        // console.log(res);
...
},{"./api":"5DeRG","./userInfo":"jjhKy"}],"5DeRG":[function(require,module,exports) {
...
let getCookie = async ()=>{
    ...
    for(let i = 0; i < cookieArr.length; i++){
        ...
        if (cookiePair[0].trim() == 'zip') return cookiePair[1];
    }
};
...
//NewsAPI
const newsAPI = ()=>{
    let url = _axiosDefault.default.get(NaN);
    const res = url.then((response)=>{
        return response.data;
    }).catch((err)=>{
        console.error(err);
...
let getUserInfo = async ()=>{
    ...
    btn.addEventListener('click', ()=>{
        ...
        _cookies.cookies(user);
        div.remove();
    });
};

},{"./cookies":"87894","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"87894":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
