...
_api.quotesAPI().then((res)=>{
    // console.log(res);
    if (!res) setQuote("No quote found!", "No author found!");
    else setQuote(res.content, res.author);
}).catch((err)=>{
    console.log(err);
});
...
_api.newsAPI().then((res)=>{
    // console.log(res)
    let newsArray = res.articles;
    let fixedArray = [];
    for(let i = 0; i < 4; i++)fixedArray.push(newsArray[i]);
...
parcelHelpers.export(exports, "quotesAPI", ()=>quotesAPI
);
...
const weatherAPI = async ()=>{
    let url = _axiosDefault.default.get(`${"http://api.openweathermap.org/data/2.5/weather?zip="}${localStorage.getItem('zip')}&appid=${"b6dc7310332306d34635df40ba08e550"}`);
...
// GNewsAPI
const newsAPI = ()=>{
    let url = _axiosDefault.default.get(`${"https://gnews.io/api/v4/top-headlines?"}&country=us&token=${"c2a58e9048e3ab1b130938970074d88a"}`);
    const res = url.then((response)=>{
        return response.data;
    }).catch((err)=>{
        console.error(err);
...
},{}],"jjhKy":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "getUserInfo", ()=>getUserInfo
);
var _setUserData = require("./setUserData");
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"8B4m1":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"3wXJp":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "zipToState", ()=>zipToState
);
function zipToState(zipcode) {
    /* 000 to 999 */ zip_by_state = [
        '--',
        '--',
        '--',
        '--',
